...
void save_basis(const CPoint2d & pt, const std::vector< int > & index, const std::vector< float > & coefs,
                const std::vector< TreeNodeD > & nodes, const std::vector< CPoint2d > & knots);
